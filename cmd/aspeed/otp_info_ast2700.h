...
static const struct otpstrap_ext_info a2_strap_ext_info[] = {
	{ 16, 1, 1, "Disable ARM ICE" },
	{ 16, 1, 0, "Enable ARM ICE" },
	{ 18, 1, 1, "VGA0/1 Class Code: Class code for video device" },
	{ 18, 1, 0, "VGA0/1 Class Code: Class Code of VGA device" },
	{ 19, 1, 1, "UFS reference clock selection: External clk (OSC)" },
	{ 19, 1, 0, "UFS reference clock selection: Internal clk" },
	{ 20, 1, 1, "eMMC Boot Speed: 50Mhz" },
	{ 20, 1, 0, "eMMC Boot Speed: low speed(25Mhz)" },
	{ 21, 1, 1, "Disable XHCI0/1" },
	{ 21, 1, 0, "Enable XHCI0/1" },
	{ 22, 1, 1, "Disable ARM ICE in Trust World" },
	{ 22, 1, 0, "Enable ARM ICE in Trust World" },
	...
	{ 26, 2, 2, "Uart Debug timeout selection" },
	{ 26, 2, 3, "Uart Debug timeout selection" },
	{ 28, 1, 1, "DAC's source selection: PCIE VGA1" },
	{ 28, 1, 0, "DAC's source selection: PCIE VGA0" },
	{ 29, 1, 1, "DisplayPort's source selection: PCIE VGA1" },
	{ 29, 1, 0, "DisplayPort's source selection: PCIE VGA0" },
	{ 30, 1, 1, "Disable RVAS0/1" },
	{ 30, 1, 0, "Enable RVAS0/1" },
	{ 32, 1, 1, "boot storage ABR enable" },
	{ 32, 1, 0, "boot storage ABR disable" },
	{ 33, 1, 1, "ROM clear SRAM" },
	{ 33, 1, 0, "ROM clear SRAM" },
	{ 39, 2, 0, "Uart Debug timeout selection" },
	{ 39, 2, 1, "Uart Debug timeout selection" },
	...
	{ 55, 2, 2, "Boot SPI Frequency Selection" },
	{ 55, 2, 3, "Boot SPI Frequency Selection" },
	{ 57, 1, 1, "check flash is ready for accessing" },
	{ 57, 1, 0, "check flash is ready for accessing" },
	{ 58, 1, 1, "disable B if ABR enabled" },
	{ 58, 1, 0, "enable B if ABR enabled" },
	...
	{ 70, 1, 1, "Selection of SIO decode address: 0x4E" },
	{ 70, 1, 0, "Selection of SIO decode address: 0x2E" },
	{ 71, 1, 1, "Disable SIO Decoding" },
	{ 71, 1, 0, "Enable SIO Decoding" },
	{ 72, 1, 1, "Enable ACPI" },
	{ 72, 1, 0, "Disable ACPI" },
	...
	{ 75, 1, 1, "Enable eSPI RTC" },
	{ 75, 1, 0, "Disable eSPI RTC" },
	{ 100, 1, 1, "Node: 64MB (DRAMC100[0])" },
	{ 100, 1, 0, "Node: Size of VGA RAM" },
	{ 103, 1, 1, "Enable PCIe VGA0" },
	{ 103, 1, 0, "Disable PCIe VGA0" },
	{ 104, 1, 1, "Enable PCIe IPMI0" },
	{ 104, 1, 0, "Disable PCIe IPMI0" },
