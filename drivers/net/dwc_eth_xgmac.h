...
#define XGMAC_DMA_SYSBUS_MODE_EN_LPI			BIT(15)
#define XGMAC_DMA_SYSBUS_MODE_LPI_XIT_PKT		BIT(14)
#define XGMAC_DMA_SYSBUS_MODE_AAL			BIT(12)
#define XGMAC_DMA_SYSBUS_MODE_EAME			BIT(11)
#define XGMAC_DMA_SYSBUS_MODE_BLEN256			BIT(7)
#define XGMAC_DMA_SYSBUS_MODE_BLEN128			BIT(6)
#define XGMAC_DMA_SYSBUS_MODE_BLEN64			BIT(5)
...
#define XGMAC_DMA_SYSBUS_MODE_BLEN_MASK			GENMASK(7, 1)
